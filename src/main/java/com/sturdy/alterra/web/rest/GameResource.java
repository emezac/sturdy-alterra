...
/**
 * REST controller for managing {@link com.sturdy.alterra.domain.Game}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GameResource {
     ...
     */
    @PutMapping("/games/{id}")
    public ResponseEntity<Game> updateGame(@PathVariable(value = "id", required = false) final UUID id, @Valid @RequestBody Game game)
        ...
        Optional<Game> result = gameRepository
            ...
            .map(existingGame -> {
                ...
                if (game.getMoves() != null) {
                    existingGame.setMoves(game.getMoves());
                }
