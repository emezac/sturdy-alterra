...
/**
 * REST controller for managing {@link com.sturdy.alterra.domain.Map}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MapResource {
     ...
     */
    @PostMapping("/maps")
    public ResponseEntity<Map> createMap(@Valid @RequestBody Map map) throws URISyntaxException {
     ...
     */
    @PutMapping("/maps/{id}")
    public ResponseEntity<Map> updateMap(@PathVariable(value = "id", required = false) final UUID id, @Valid @RequestBody Map map)
    ...
    public ResponseEntity<Map> partialUpdateMap(@PathVariable(value = "id", required = false) final UUID id, @NotNull @RequestBody Map map)
        throws URISyntaxException {
        ...
        Optional<Map> result = mapRepository
            ...
            .map(existingMap -> {
                ...
                if (map.getDescription() != null) {
                    existingMap.setDescription(map.getDescription());
                }
     ...
     */
    @GetMapping("/maps/{id}")
    public ResponseEntity<Map> getMap(@PathVariable UUID id) {
