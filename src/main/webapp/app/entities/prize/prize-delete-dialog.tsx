...
import { getEntity, deleteEntity } from './prize.reducer';
...
export const PrizeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sturdyalterraApp.prize.delete.question">Are you sure you want to delete Prize {prizeEntity.id}?</ModalBody>
      <ModalFooter>
