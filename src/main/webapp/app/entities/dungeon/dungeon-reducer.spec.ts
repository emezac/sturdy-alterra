...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dungeon.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DUNGEON_LIST actions', async () => {
    ...
    it('dispatches FETCH_DUNGEON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DUNGEON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DUNGEON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DUNGEON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DUNGEON actions', async () => {
      const expectedActions = [
        {
