...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLOORCONFIG_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLOORCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLOORCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLOORCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLOORCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLOORCONFIG actions', async () => {
      const expectedActions = [
        {
