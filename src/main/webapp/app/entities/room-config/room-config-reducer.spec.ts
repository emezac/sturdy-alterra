...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMCONFIG_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOMCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOMCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOMCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOMCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOMCONFIG actions', async () => {
      const expectedActions = [
        {
