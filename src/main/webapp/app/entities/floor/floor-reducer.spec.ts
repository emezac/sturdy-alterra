...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './floor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLOOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLOOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLOOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLOOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLOOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLOOR actions', async () => {
      const expectedActions = [
        {
