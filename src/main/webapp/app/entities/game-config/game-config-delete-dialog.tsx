...
export const GameConfigDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sturdyalterraApp.gameConfig.delete.question">
        Are you sure you want to delete Game Config {gameConfigEntity.id}?
      </ModalBody>
      <ModalFooter>
