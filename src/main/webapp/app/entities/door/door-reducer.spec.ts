...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './door.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOOR actions', async () => {
      const expectedActions = [
        {
