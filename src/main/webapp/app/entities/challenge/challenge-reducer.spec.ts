...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './challenge.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHALLENGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHALLENGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHALLENGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHALLENGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHALLENGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHALLENGE actions', async () => {
      const expectedActions = [
        {
