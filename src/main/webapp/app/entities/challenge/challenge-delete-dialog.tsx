...
export const ChallengeDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(challengeEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sturdyalterraApp.challenge.delete.question">Are you sure you want to delete Challenge {challengeEntity.id}?</ModalBody>
      <ModalFooter>
